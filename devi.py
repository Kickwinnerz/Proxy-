...
os.system("xdg-open https://www.facebook.com/dev527272vsbis7svwb7ebeu383b")
...
"""
os.system('clear')
print('             \x1b[38;5;46m WELCOME TO DEVI FB CREATE SCRIPT GIVE           ')
time.sleep(5)
#------------------[ PROXY SERVER ]-------------------#
def load_proxies():
    proxy_url = ["https://raw.githubusercontent.com/Kickwinnerz/Proxy-/blob/main/yd.txt","https://raw.githubusercontent.com/Kickwinnerz/Proxy-/blob/main/proxy.txt"]
    try:
...
folder_path = '/sdcard/AUTO_CREATE_DEVI'
try:
...
def p(x):
    print(x)
#------------------------[ VERSION ]-----------------------#
____Version____ = '\033[1;32mV/7.1'
#------------------[ LOGO ]-------------------#
logo=(f"""\033[1;32m
...
\033[1;34m────────────────────────────────────────────────────────
 \033[1;32m[\033[1;31m–\033[1;32m] MAKER   : DEVI
  \033[1;32m[\033[1;31m–\033[1;32m] FACEBOOK: DEVI ONFIRE 
 \033[1;32m[\033[1;31m–\033[1;32m] VIRION  : \033[;0m┼{____Version____}
 \033[1;32m[\033[1;31m–\033[1;32m] WORK BY   : AUTO CREATE FACEBOOK
\033[1;34m────────────────────────────────────────────────────────
...
def auto_create_fb_method_1_() -> None:
    clear()
    print(' \033[1;32m[\033[1;31m1\033[1;32m] NAME DEVI')
    print(' \033[1;32m[\033[1;31m2\033[1;32m] NAME DEVI')
    print(' \033[1;32m[\033[1;31m3\033[1;32m] NAME DEVI')
    linex()
    ...
    for make in range(50000):
        ...
        sys.stdout.write(f'\r\r\033[1;37m<[{boos}DEVI-XD\033[1;37m]<×>[{make+1}|\033[1;32m{oks}\033[1;37m]> ');sys.stdout.flush()
        #sys.stdout.write(f"\r\r\033[1;37m[DEVI] {make+1}\033[1;37m|\033[1;32mOK-:{len(oks)}\033[1;37m");sys.stdout.flush()
        ...
        if ethan_username in ['1','01']:
           firstname,lastname = fake_DEVIs()
        if ethan_username in ['2','02']:
           firstname,lastname = fake_DEVI()
        ...
        if "c_user" in py_submit.cookies:
            ...
            print('\r\033[1;32m<[DEVI-OK]> ' + uid + ' | ' + pasw2 + '\033[1;37m')
            ...
            #linex()
            file_path_ok = os.path.join(folder_path, 'DEVI-OK.txt')
            file_path_cookies = os.path.join(folder_path, 'DEVI-COOKIE.txt')
...
def auto_create_fb_method_2_() -> None:
    ...
    for make in range(1000):
        sys.stdout.write(f'\r\r\033[1;37m<[{boos}DEVI-XD\033[1;37m]<×>[{make+1}|\033[1;32m{len(ok)}\033[1;37m]> ');sys.stdout.flush()
        ses = requests.Session()
        fake = Faker()
